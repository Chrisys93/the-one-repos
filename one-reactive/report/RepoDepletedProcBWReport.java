 ...
 */
public class RepoDepletedProcBWReport extends Report implements UpdateListener {
	 ...
	 */
	public RepoDepletedProcBWReport() {
				...
				//if (isTracked(m)) {
					//if (isFirstMessage) {
						...
						if (hostname.contains("r") ){
							//reportLine += " " + hostname;
							double totalStoredMsgs =  host.getStorageSystem().getDepletedProcMessagesBW(true, false);
