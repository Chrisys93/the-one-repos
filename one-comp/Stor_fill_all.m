...
%TSDS:
% Modify this:
lgd1 =legend('1: f; 0.1; 1; 1.1; 100; 3:1; \newline2: f; 0.2; 3; 3; 100; 4:1; \newline3: t; 0.3; 3; 4; 300; 4:1; \newline4: t; 0.1; 1; 2; 300; 1:2', ...
            '1: f; 0.1; 1; 1.3; 300; 3:1; \newline2: f; 0.2; 3; 3.2; 300; 4:1; \newline3: t; 0.3; 2; 2.2; 800; 4:1;  \newline4: t; 0.1; 1; 2; 800; 2:2', ...
            '1: f; 0.1; 1.5; 2; 500; 3:1; \newline2: f; 0.2; 3; 50; 500; 4:1; \newline3: f; 0.3; 2; 3; 300 4:1; \newline4: f; 0.1; 1; 2; 600; 4:2', ...
            '1: f; 0.1; 2; 2.5; 600; 3:1; \newline2: f; 0.1; 2; 3; 600; 4:1; \newline3: f; 0.2; 3; 4; 600 4:1; \newline4: f; 0.1; 1; 2; 600; 5:2', ...
            '1: f; 0.1; 3; 3.1; 800; 3:1; \newline2: f; 0.1; 2; 3.2; 800; 4:1; \newline3: f; 0.1; 2; 2.2; 800 4:1; \newline4: f; 0.1; 1; 2; 800; 3:1', ...
            '1: f; 0.1; 1; 2; 1000; 4:1; 50k \newline2: f; 0.1; 2; 50; 1000; 4:1; 1M; \newline3: f; 0.1; 2; 3; 1000 4:1; 1M; \newline4: f; 0.1; 1; 2; 1000; 4:1; 500k', 'Location', 'southoutside');
title(lgd1, 'Scenario Number: Storage Mode; Processing Delay; proc Freshness Period; proc Shelf-Life; non-proc Shelf-Life; Non-Proc:Proc Ratio; Message Size (last, B)');
lgd1.NumColumns = 6;
% xlim([17 48]);
% set(bar_handle(1),'FaceColor',[0,0.5,1])
% set(bar_handle(2),'FaceColor',[0,1,0])
