...
clear
M1 = dlmread('non_proc_sim/proc_sims/MDMR1', ' ', 0, 2);
S1 = dlmread('non_proc_sim/proc_sims/RAMR1', ' ', 0, 2);
PB1 = dlmread('non_proc_sim/proc_sims/RPBWR1', ' ', 0, 2);
UB1 = dlmread('non_proc_sim/proc_sims/RUPBWR1', ' ', 0, 2);
SB1 = dlmread('non_proc_sim/proc_sims/RSBWR1', ' ', 0, 2);
RI1 = dlmread('non_proc_sim/proc_sims/RISR1', ' ', 0, 2);
RP1 = dlmread('non_proc_sim/proc_sims/RPrMR1', ' ', 0, 2);
RS1 = dlmread('non_proc_sim/proc_sims/RSMR1', ' ', 0, 2);

M2 = dlmread('non_proc_sim/proc_sims/MDMR2', ' ', 0, 2);
S2 = dlmread('non_proc_sim/proc_sims/RAMR2', ' ', 0, 2);
UB2 = dlmread('non_proc_sim/proc_sims/RUPBWR2', ' ', 0, 2);
PB2 = dlmread('non_proc_sim/proc_sims/RPBWR2', ' ', 0, 2);
SB2 = dlmread('non_proc_sim/proc_sims/RSBWR2', ' ', 0, 2);
RI2 = dlmread('non_proc_sim/proc_sims/RISR2', ' ', 0, 2);
RP2 = dlmread('non_proc_sim/proc_sims/RPrMR2', ' ', 0, 2);
RS2 = dlmread('non_proc_sim/proc_sims/RSMR2', ' ', 0, 2);

M3 = dlmread('non_proc_sim/proc_sims/MDMR3', ' ', 0, 2);
S3 = dlmread('non_proc_sim/proc_sims/RAMR3', ' ', 0, 2);
PB3 = dlmread('non_proc_sim/proc_sims/RPBWR3', ' ', 0, 2);
UB3 = dlmread('non_proc_sim/proc_sims/RUPBWR3', ' ', 0, 2);
SB3 = dlmread('non_proc_sim/proc_sims/RSBWR3', ' ', 0, 2);
RI3 = dlmread('non_proc_sim/proc_sims/RISR3', ' ', 0, 2);
RP3 = dlmread('non_proc_sim/proc_sims/RPrMR3', ' ', 0, 2);
RS3 = dlmread('non_proc_sim/proc_sims/RSMR3', ' ', 0, 2);

M4 = dlmread('non_proc_sim/proc_sims/MDMR4', ' ', 0, 2);
S4 = dlmread('non_proc_sim/proc_sims/RAMR4', ' ', 0, 2);
UB4 = dlmread('non_proc_sim/proc_sims/RUPBWR4', ' ', 0, 2);
PB4 = dlmread('non_proc_sim/proc_sims/RPBWR4', ' ', 0, 2);
SB4 = dlmread('non_proc_sim/proc_sims/RSBWR4', ' ', 0, 2);
RI4 = dlmread('non_proc_sim/proc_sims/RISR4', ' ', 0, 2);
RP4 = dlmread('non_proc_sim/proc_sims/RPrMR4', ' ', 0, 2);
RS4 = dlmread('non_proc_sim/proc_sims/RSMR4', ' ', 0, 2);

M5 = dlmread('non_proc_sim/proc_sims/MDMR5', ' ', 0, 2);
S5 = dlmread('non_proc_sim/proc_sims/RAMR5', ' ', 0, 2);
PB5 = dlmread('non_proc_sim/proc_sims/RPBWR5', ' ', 0, 2);
UB5 = dlmread('non_proc_sim/proc_sims/RUPBWR5', ' ', 0, 2);
SB5 = dlmread('non_proc_sim/proc_sims/RSBWR5', ' ', 0, 2);
RI5 = dlmread('non_proc_sim/proc_sims/RISR5', ' ', 0, 2);
RP5 = dlmread('non_proc_sim/proc_sims/RPrMR5', ' ', 0, 2);
RS5 = dlmread('proc_sims/RSMR5', ' ', 0, 2);
...
mdeleted1 = [mean(M1(10800, 1:40)), mean(M1(10800, 41:240)), mean(M1(10800, 241:255));
             ...
             mean(M3(10800, 1:40)), mean(M3(10800, 41:840)), mean(M3(10800, 841:855));
             mean(M4(10800, 1:40)), mean(M4(10800, 41:1040)), mean(M4(10800, 1041:1055));
             mean(M5(10800, 1:40)), mean(M5(10800, 41:1240)), mean(M5(10800, 1241:1255))];
% mdeleted2 = M2(10000, :);
% mdeleted3 = M3(10000, :);
% addr1 = 80:334;
% addr2 = 80:634;
...
figure
% subplot(1,3,1);
bar([200, 500, 800, 1000, 1200], mdeleted1);
...
lgd = legend('200 cars', '500 cars', '800 cars', '1000 cars', '1200 cars');
lgd.FontSize = 9;
...
subplot(1,2,1);
bar([200, 500, 800, 1000, 1200], upspeeds1_30, 'stacked');
lgd = legend('non-processing message upload', 'cloud offloading upload', 'processed message upload');
lgd.FontSize = 10;
...
subplot(1,2,2);
bar([200, 500, 800, 1000, 1200], inspeeds1_30);
xlabel('No. of cars in simulation','fontsize',12) 
ylabel('Bandwidth of input (B)','fontsize',12)
...
figure
bar([200, 500, 800, 1000, 1200], storages_30, 'stacked');
