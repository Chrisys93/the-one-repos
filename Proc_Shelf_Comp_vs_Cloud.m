...
HPB1 = dlmread('one-comp/homeIoT/RPBWR1', ' ', 0, 1);
BPB1 = dlmread('one-comp/buses/RPBWR1', ' ', 0, 1);
PPB1 = dlmread('one-comp/non-proc_proc/RPBWR1', ' ', 0, 1);


OPB2 = dlmread('one-comp/officeIoT/RPBWR2', ' ', 0, 1);
HPB2 = dlmread('one-comp/homeIoT/RPBWR2', ' ', 0, 1);
BPB2 = dlmread('one-comp/buses/RPBWR2', ' ', 0, 1);
PPB2 = dlmread('one-comp/non-proc_proc/RPBWR2', ' ', 0, 1);


OPB3 = dlmread('one-comp/officeIoT/RPBWR3', ' ', 0, 1);
HPB3 = dlmread('one-comp/homeIoT/RPBWR3', ' ', 0, 1);
BPB3 = dlmread('one-comp/buses/RPBWR3', ' ', 0, 1);
PPB3 = dlmread('one-comp/non-proc_proc/RPBWR3', ' ', 0, 1);


OPB4 = dlmread('one-comp/officeIoT/RPBWR4', ' ', 0, 1);
HPB4 = dlmread('one-comp/homeIoT/RPBWR4', ' ', 0, 1);
BPB4 = dlmread('one-comp/buses/RPBWR4', ' ', 0, 1);
PPB4 = dlmread('one-comp/non-proc_proc/RPBWR4', ' ', 0, 1);


OPB5 = dlmread('one-comp/officeIoT/RPBWR5', ' ', 0, 1);
HPB5 = dlmread('one-comp/homeIoT/RPBWR5', ' ', 0, 1);
BPB5 = dlmread('one-comp/buses/RPBWR5', ' ', 0, 1);
PPB5 = dlmread('one-comp/non-proc_proc/RPBWR5', ' ', 0, 1);


OPB6 = dlmread('one-comp/officeIoT/RPBWR6', ' ', 0, 1);
HPB6 = dlmread('one-comp/homeIoT/RPBWR6', ' ', 0, 1);
BPB6 = dlmread('one-comp/buses/RPBWR6', ' ', 0, 1);
PPB6 = dlmread('one-comp/non-proc_proc/RPBWR6', ' ', 0, 1);

OUB1 = dlmread('one-cloud/officeIoT/RPBWR1', ' ', 0, 1);
HUB1 = dlmread('one-cloud/homeIoT/RPBWR1', ' ', 0, 1);
BUB1 = dlmread('one-cloud/buses/RPBWR1', ' ', 0, 1);
PUB1 = dlmread('one-cloud/non-proc_proc/RPBWR1', ' ', 0, 1);


OUB2 = dlmread('one-cloud/officeIoT/RPBWR2', ' ', 0, 1);
HUB2 = dlmread('one-cloud/homeIoT/RPBWR2', ' ', 0, 1);
BUB2 = dlmread('one-cloud/buses/RPBWR2', ' ', 0, 1);
PUB2 = dlmread('one-cloud/non-proc_proc/RPBWR2', ' ', 0, 1);


OUB3 = dlmread('one-cloud/officeIoT/RPBWR3', ' ', 0, 1);
HUB3 = dlmread('one-cloud/homeIoT/RPBWR3', ' ', 0, 1);
BUB3 = dlmread('one-cloud/buses/RPBWR3', ' ', 0, 1);
PUB3 = dlmread('one-cloud/non-proc_proc/RPBWR3', ' ', 0, 1);


OUB4 = dlmread('one-cloud/officeIoT/RPBWR4', ' ', 0, 1);
HUB4 = dlmread('one-cloud/homeIoT/RPBWR4', ' ', 0, 1);
BUB4 = dlmread('one-cloud/buses/RPBWR4', ' ', 0, 1);
PUB4 = dlmread('one-cloud/non-proc_proc/RPBWR4', ' ', 0, 1);


OUB5 = dlmread('one-cloud/officeIoT/RPBWR5', ' ', 0, 1);
HUB5 = dlmread('one-cloud/homeIoT/RPBWR5', ' ', 0, 1);
BUB5 = dlmread('one-cloud/buses/RPBWR5', ' ', 0, 1);
PUB5 = dlmread('one-cloud/non-proc_proc/RPBWR5', ' ', 0, 1);


OUB6 = dlmread('one-cloud/officeIoT/RPBWR6', ' ', 0, 1);
HUB6 = dlmread('one-cloud/homeIoT/RPBWR6', ' ', 0, 1);
BUB6 = dlmread('one-cloud/buses/RPBWR6', ' ', 0, 1);
PUB6 = dlmread('one-cloud/non-proc_proc/RPBWR6', ' ', 0, 1);
