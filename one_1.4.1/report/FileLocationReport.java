 ...
 */
public class FileLocationReport extends Report implements UpdateListener {
	...
	/**
	 * Creates a new snapshot of the file locations if "granularity" 
