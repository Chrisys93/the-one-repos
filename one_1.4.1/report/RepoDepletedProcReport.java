 ...
 */
public class RepoDepletedProcReport extends Report implements UpdateListener {
				...
				//if (isTracked(m)) {
					//if (isFirstMessage) {
						...
						if (hostname.contains("r") ){
							//reportLine += " " + hostname;
							double totalStoredMsgs =  host.getStorageSystem().getNrofDepletedProcMessages() ;
