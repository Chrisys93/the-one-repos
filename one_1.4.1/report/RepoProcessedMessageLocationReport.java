 ...
 */
public class RepoProcessedMessageLocationReport extends Report implements UpdateListener {
	 ...
	 */
	public RepoProcessedMessageLocationReport() {
				...
				//if (isTracked(m)) {
					//if (isFirstMessage) {
						...
						if (hostname.contains("r") ){
							//reportLine += " " + hostname;
							int totalStoredMsgs =  host.getStorageSystem().getNrofProcessedMessages();
