...
clear
M1 = dlmread('reports31/MDMR1', ' ', 0, 2);
S1 = dlmread('reports31/RAMR1', ' ', 0, 2);
PB1 = dlmread('reports31/RPBWR1', ' ', 0, 2);
UB1 = dlmread('reports31/RUPBWR1', ' ', 0, 2);
SB1 = dlmread('reports31/RSBWR1', ' ', 0, 2);
RI1 = dlmread('reports31/RISR1', ' ', 0, 2);
RP1 = dlmread('reports31/RPrMR1', ' ', 0, 2);
RS1 = dlmread('reports31/RSMR1', ' ', 0, 2);

M2 = dlmread('reports31/MDMR2', ' ', 0, 2);
S2 = dlmread('reports31/RAMR2', ' ', 0, 2);
UB2 = dlmread('reports31/RUPBWR2', ' ', 0, 2);
PB2 = dlmread('reports31/RPBWR2', ' ', 0, 2);
SB2 = dlmread('reports31/RSBWR2', ' ', 0, 2);
RI2 = dlmread('reports31/RISR2', ' ', 0, 2);
RP2 = dlmread('reports31/RPrMR2', ' ', 0, 2);
RS2 = dlmread('reports31/RSMR2', ' ', 0, 2);

% M3 = dlmread('reports31/MDMR3', ' ', 0, 2);
% S3 = dlmread('reports31/RAMR3', ' ', 0, 2);
% PB3 = dlmread('reports31/RPBWR3', ' ', 0, 2);
% UB3 = dlmread('reports31/RUPBWR3', ' ', 0, 2);
% SB3 = dlmread('reports31/RSBWR3', ' ', 0, 2);
% RI3 = dlmread('reports31/RISR3', ' ', 0, 2);
% RP3 = dlmread('reports31/RPrMR3', ' ', 0, 2);
% RS3 = dlmread('reports31/RSMR3', ' ', 0, 2);

M3 = dlmread('reports31/MDMR4', ' ', 0, 2);
S3 = dlmread('reports31/RAMR4', ' ', 0, 2);
PB3 = dlmread('reports31/RPBWR4', ' ', 0, 2);
UB3 = dlmread('reports31/RUPBWR4', ' ', 0, 2);
SB3 = dlmread('reports31/RSBWR4', ' ', 0, 2);
RI3 = dlmread('reports31/RISR4', ' ', 0, 2);
RP3 = dlmread('reports31/RPrMR4', ' ', 0, 2);
RS3 = dlmread('reports31/RSMR4', ' ', 0, 2);

% M5 = dlmread('reports31/MDMR5', ' ', 0, 2);
% S5 = dlmread('reports31/RAMR5', ' ', 0, 2);
% UB5 = dlmread('reports31/RUPBWR5', ' ', 0, 2);
% PB5 = dlmread('reports31/RPBWR5', ' ', 0, 2);
% SB5 = dlmread('reports31/RSBWR5', ' ', 0, 2);
% RI5 = dlmread('reports31/RISR5', ' ', 0, 2);
% RP5 = dlmread('reports31/RPrMR5', ' ', 0, 2);
% RS5 = dlmread('reports31/RSMR5', ' ', 0, 2);

% M6 = dlmread('reports31/MDMR6', ' ', 0, 2);
% S6 = dlmread('reports31/RAMR6', ' ', 0, 2);
% PB6 = dlmread('reports31/RPBWR6', ' ', 0, 2);
% UB6 = dlmread('reports31/RUPBWR6', ' ', 0, 2);
% SB6 = dlmread('reports31/RSBWR6', ' ', 0, 2);
% RI6 = dlmread('reports31/RISR6', ' ', 0, 2);
% RP6 = dlmread('reports31/RPrMR6', ' ', 0, 2);
% RS6 = dlmread('reports31/RSMR6', ' ', 0, 2);
...
mdeleted1 = [mean(M1(10000, 1:40)), mean(M1(10000, 41:440)), mean(M1(10000, 441:455));
             mean(M2(10000, 1:40)), mean(M2(10000, 41:840)), mean(M2(10000, 841:855));
             mean(M3(10000, 1:40)), mean(M3(10000, 41:1240)), mean(M3(10000, 1241:1255))];
for i = 1:10000
...
inspeeds1_30 = [mean(RI1_mean), mean(RI2_mean), mean(RI3_mean)];
...
% subplot(1,3,1);
% yyaxis left
plot([80, 100, 120], mdeleted1(:, 1), '-d', [80, 100, 120], mdeleted1(:, 2), ':d', [80, 100, 120], mdeleted1(:, 3), '-.d', 'LineWidth', 1);
...
hold on
grid on
plot([80, 100, 120], upspeeds1_30(:, 1), '-o', [80, 100, 120], upspeeds1_30(:, 2), ':o', [80, 100, 120], upspeeds1_30(:, 3), '-.o', 'LineWidth', 1);
plot([80, 100, 120], inspeeds1_30, '-^', 'LineWidth', 1);
ylabel('Bandwidth of input (B)','fontsize',12)
xlabel('No. of Repos in simulation','fontsize',12) 
ylabel('Bandwidth used (B)','fontsize',12)

yyaxis right
semilogy([80, 100, 120], storages_30(:, 1), '-^', [80, 100, 120], storages_30(:, 2), ':v', 'LineWidth', 1);
grid on
...
%                 mean(RS4_mean), mean(RP4_mean)];
% figure
% bar([80, 100, 120], storages_30, 'stacked');
