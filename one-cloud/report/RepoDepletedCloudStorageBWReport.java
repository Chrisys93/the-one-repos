 ...
 */
public class RepoDepletedCloudStorageBWReport extends Report implements UpdateListener {
	 ...
	 */
	public RepoDepletedCloudStorageBWReport() {
				...
				//if (isTracked(m)) {
					//if (isFirstMessage) {
						...
						if (hostname.contains("r") ){
							//reportLine += " " + hostname;
							double totalStoredMsgs =  host.getStorageSystem().getDepletedCloudStaticMessagesBW(true);
