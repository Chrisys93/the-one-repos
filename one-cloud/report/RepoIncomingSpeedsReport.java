 ...
 */
public class RepoIncomingSpeedsReport extends Report implements UpdateListener {
	 ...
	 */
	public RepoIncomingSpeedsReport() {
				...
				//if (isTracked(m)) {
					//if (isFirstMessage) {
						...
						if (hostname.contains("r") ){
							//reportLine += " " + hostname;
							reportLine += " " + host.getStorageSystem().getOverallMeanIncomingSpeed();
