 ...
 */
public class MobileDeletedMessagesReport extends Report implements UpdateListener {
	 ...
	 */
	public MobileDeletedMessagesReport() {
				...
				//if (isTracked(m)) {
					//if (isFirstMessage) {
						...
						if (!hostname.contains("r") ){
							//reportLine += " " + hostname;
							reportLine += " " + host.getRouter().getBufferDeletedMessagesSize();
